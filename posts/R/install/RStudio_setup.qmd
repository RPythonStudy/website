...
### 주의사항
- Ubuntu와는 다르게 WSL2에 설치된 우분투는 GUI를 지원하지 않습니다. 따라서 RStudio Desktop을 설치할 수 없으며, RStudio Server를 설치하여 웹 브라우저를 통해 접속하는 방식으로 사용해야 합니다.
...
- Rstudio Server나 Posit Workbench에서는 관리자 설정 이후 사용이 가능하다고 한다.
